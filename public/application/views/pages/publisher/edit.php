            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row mt-5">
                        ...
                        <!--end col-->
                        <div class="col-lg-12">
                            <form id="countryForm" method="post" action="<?php echo base_url('admin/publisher/edit/'.$id); ?>" enctype="multipart/form-data">
                                <div class="card">
                                            ...
                                            <div class="row gy-4">
                                                <div class="col-xxl-4 col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="code" name="code" placeholder="Enter publisher code" value="<?php echo form_error('code') ? set_value('code') : $data->code; ?>">
                                                ...
                                                <div class="col-xxl-4 col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter publisher name" value="<?php echo form_error('name') ? set_value('name') : $data->name; ?>">
                                                ...
                                                <div class="col-xxl-4 col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="place" name="place" placeholder="Enter publisher place" value="<?php echo form_error('place') ? set_value('place') : $data->place; ?>">
                                                ...
                                                <div class="col-xxl-12 col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="address" id="address" placeholder="Enter publisher address" class="form-control"><?php echo form_error('address') ? set_value('address') : $data->address; ?></textarea>
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" class="form-control" id="email" name="email" placeholder="Enter publisher email" value="<?php echo form_error('email') ? set_value('email') : $data->email; ?>">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter publisher phone" value="<?php echo form_error('phone') ? set_value('phone') : $data->phone; ?>">
