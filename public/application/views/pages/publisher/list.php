                                    ...
                                    <div id="customerList">
                                        <div class="row g-4 mb-3">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <a href="<?php echo base_url('admin/publisher/create'); ?>"
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name"><?php echo $page_name; ?> Phone</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="customer_name"><?php echo $item->phone; ?></td>
                                                        <td class="date"><?php echo $item->timestamp; ?></td>
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                    <a href="<?php echo base_url('admin/publisher/edit/'.$this->encryption_url->safe_b64encode($item->id)); ?>"
                                                                ...
                                                                <div class="remove">
                                                                    <button
                                                                        ...
                                                                        onclick="deleteHandler('<?php echo base_url('admin/publisher/delete/'.$this->encryption_url->safe_b64encode($item->id)); ?>')">Delete</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
