                                            ...
                                            <div class="row gy-4">
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter journal title" value="<?php echo $data->title; ?>">
                                                ...
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="edition" name="edition" placeholder="Enter journal edition" value="<?php echo $data->edition; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="isbn" name="isbn" placeholder="Enter journal isbn" value="<?php echo $data->isbn; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="date" name="date" placeholder="Enter publishing date of journal" value="<?php echo $data->date; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="link" name="link" placeholder="Enter journal website link KUH website" value="<?php echo $data->link; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter journal name" value="<?php echo $data->name; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
            ...
            $(document).ready(function() {
                ...
                $('#countryForm').validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url('admin/journal/update/'.$id); ?>",
                            data: formData,
                            processData: false,
                            contentType: false,
                            cache: false,
