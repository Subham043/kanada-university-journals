            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row mt-5">
                        ...
                        <!--end col-->
                        <div class="col-lg-12">
                            <form id="countryForm" method="post" action="<?php echo base_url('admin/department/create'); ?>" enctype="multipart/form-data">
                                <div class="card">
                                            ...
                                            <div class="row gy-4">
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="code" name="code" placeholder="Enter department code" value="<?php echo set_value('code'); ?>">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter department name" value="<?php echo set_value('name'); ?>">
