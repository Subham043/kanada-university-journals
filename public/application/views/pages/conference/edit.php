                                            ...
                                            <div class="row gy-4">
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter conference title" value="<?php echo $data->title; ?>">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="conference" name="conference" placeholder="Enter name of conference" value="<?php echo $data->conference; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="isbn" name="isbn" placeholder="Enter conference isbn" value="<?php echo $data->isbn; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="date" name="date" placeholder="Enter date of conference" value="<?php echo $data->date; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="link" name="link" placeholder="Enter conference website link KUH website" value="<?php echo $data->link; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="book" name="book" placeholder="Enter book name" value="<?php echo $data->book; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="editor" name="editor" placeholder="Enter editor name" value="<?php echo $data->editor; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                ...
                                                <div class="col-xxl-12 col-md-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea name="place" class="form-control" id="place" placeholder="Enter conference place" rows="5"><?php echo $data->place; ?></textarea>
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                ...
                <?php foreach($teacher as $teacher){ ?>
                    {
                        ...
                        selected: <?php echo $teacher->id==$data->teacher_id ? 'true' : 'false'; ?>,
                    },
                <?php } ?>
            ],
                ...
                <?php foreach($keyword as $keyword){ ?>
                    {
                        ...
                        selected: <?php echo $keyword->id==$data->keyword_id ? 'true' : 'false'; ?>,
                    },
                <?php } ?>
            ],
