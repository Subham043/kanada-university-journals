...
<body>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-12">
                            <form id="countryForm" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="live-preview">
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="co_teacher_id" class="form-label"><?php echo $page_name; ?> Co-Author</label>
                                                        <select class="form-control" id="co_teacher_id" name="co_teacher_id[]" multiple></select>
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-6">
                                        ...
                                        <div class="live-preview" data-repeater-list="group-a">
                                            <?php if(empty($selected_add_teacher)){ ?>
                                                <div class="row gy-4 p-3" data-repeater-item>
                                                    <div class="col-xxl-4 col-md-6">
                                                        <div class="form-group mb-3">
                                                            <label for="teacher_name" class="form-label"><?php echo $page_name; ?> Author Name</label>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6">
                                                        <div class="form-group mb-3">
                                                            <label for="teacher_email" class="form-label"><?php echo $page_name; ?> Author Email</label>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6">
                                                        <div class="form-group mb-3">
                                                            <label for="teacher_mobile" class="form-label"><?php echo $page_name; ?> Author Mobile</label>
                                ...
                                <div class="card repeater-co-teacher">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Additional Co-Author From Other University</h4>
                                        <button
                                            type="button"
                                            data-repeater-create
                                            style="background:green;border-color:green;" type="button"
                                    ...
                                    <div class="card-body p-0">
                                        <div class="live-preview">
                                            <div class="row gy-4 p-3" data-repeater-list="group-a">
                                                <?php if(empty($selected_add_co_teacher)){ ?>
                                                    <div class="col-xxl-4 col-md-6" data-repeater-item>
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control co_teacher_name" name="co_teacher_name[]" placeholder="Enter co-teacher name" value="">
                                                            <i class="invalid-message error"></i>
                                                        </div>
                                                        <button
                                                            type="button"
                                                ...
                                                <?php }else{ ?>
                                                    <?php foreach($selected_add_co_teacher as $selected_add_co_teacher){ ?>
                                                    <div class="col-xxl-4 col-md-6" data-repeater-item>
                                                        <div class="form-group mb-3">
                                                            <label for="co_teacher_name" class="form-label"><?php echo $page_name; ?> Editor Name</label>
                                                            <input type="text" class="form-control co_teacher_name" name="co_teacher_name[]" placeholder="Enter co-teacher name" value="<?php echo $selected_add_co_teacher->co_teacher_name; ?>">
                                                            <i class="invalid-message error"></i>
                                                        </div>
                                                        <button
                                                            type="button"
                                ...
                                <div class="card repeater-co-editor">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="live-preview">
                                            <div class="row gy-4 p-3" data-repeater-list="group-a">
                                                <?php if(empty($selected_add_co_editor)){ ?>
                                                    <div class="col-xxl-4 col-md-6" data-repeater-item>
                                                        <div class="form-group mb-3">
                                                            <label for="co_editor_name" class="form-label"><?php echo $page_name; ?> Co-Editor Name</label>
                                                            <input type="text" class="form-control co_editor_name" name="co_editor_name[]" placeholder="Enter co-editor name" value="">
                                                            <i class="invalid-message error"></i>
                                                        </div>
                                                        <button
                                                            type="button"
                                                ...
                                                <?php }else{ ?>
                                                    <?php foreach($selected_add_co_editor as $selected_add_co_editor){ ?>
                                                    <div class="col-xxl-4 col-md-6" data-repeater-item>
                                                        <div class="form-group mb-3">
                                                            <label for="co_editor_name" class="form-label"><?php echo $page_name; ?> Co-Editor Name</label>
                                                            <input type="text" class="form-control co_editor_name" name="co_editor_name[]" placeholder="Enter co-editor name" value="<?php echo $selected_add_co_editor->co_editor_name; ?>">
                                                            <i class="invalid-message error"></i>
                                                        </div>
                                                        <button
                                                            type="button"
    ...
    <script type="text/javascript" nonce="<?php echo $nonce; ?>">
            ...
            $(document).ready(function() {
                ...
                $('#countryForm').validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        if(document.getElementById('co_teacher_id')?.length>0){
                            for (let index = 0; index < document.getElementById('co_teacher_id').length; index++) {
                                formData.append('co_teacher_id[]',document.getElementById('co_teacher_id')[index].value)
                            }
                        }
                        ...
                        const co_teacher_name = document.querySelectorAll('.co_teacher_name');
                        for (let index = 0; index < co_teacher_name.length; index++) {
                            if(co_teacher_name[index].value){
                                formData.append('co_teacher_name[]',co_teacher_name[index].value)
                            }
                        }
        ...
        const coTeacherChoice = new Choices('#co_teacher_id', {
            choices: [
                <?php foreach($co_teacher as $co_teacher){ ?>
                    {
                        value: '<?php echo $co_teacher->id; ?>',
                        label: '<?php echo $co_teacher->first_name; ?> ~ <?php echo $co_teacher->code; ?>',
                        selected: <?php echo (in_array($co_teacher->id, $selected_co_teacher)) ? 'true' : 'false'; ?>,
                    },
                <?php } ?>
            ],
            placeholderValue: 'Select a co-author',
            ...CHOICE_CONFIG
        });
                ...
                <?php foreach($co_editor as $co_editor){ ?>
                    {
                        ...
                        selected: <?php echo (in_array($co_editor->id, $selected_co_editor)) ? 'true' : 'false'; ?>,
                    },
                <?php } ?>
            ],
                ...
                <?php foreach($department as $department){ ?>
                    {
                        ...
                        selected: <?php echo $data->department_id==$department->id ? 'true' : 'false'; ?>,
                    },
                <?php } ?>
            ],
