                        ...
                        <div class="col-lg-12">
                            <form id="countryForm" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row gy-4">
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter book title" value="<?php echo set_value('title'); ?>">
                                                ...
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="edition" name="edition" placeholder="Enter book edition" value="<?php echo set_value('edition'); ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="isbn" name="isbn" placeholder="Enter book isbn" value="<?php echo set_value('isbn'); ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="date" name="date" placeholder="Enter publishing date of book" value="<?php echo set_value('date'); ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="link" name="link" placeholder="Enter book website link KUH website" value="<?php echo set_value('link'); ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter book name" value="<?php echo set_value('name'); ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                ...
                                <div class="card repeater-co-editor">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Additional Co-Authors From Other University</h4>
                                        <button
                                            type="button"
                                            data-repeater-create
                                            style="background:green;border-color:green;" type="button"
