                                    ...
                                    <div id="customerList">
                                        <div class="row g-4 mb-3">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <a href="<?php echo base_url('admin/book/create'); ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                    <a href="<?php echo base_url('admin/book/edit/'.$this->encryption_url->safe_b64encode($item->id)); ?>"
                                                                ...
                                                                <div class="remove">
                                                                    <button
                                                                        ...
                                                                        onclick="deleteHandler('<?php echo base_url('admin/book/delete/'.$this->encryption_url->safe_b64encode($item->id)); ?>')">Delete</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
