                            ...
                            <div class="card ">
                                <div class="card-header">
                                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="<?php echo base_url('teacher/'.$this->encryption_url->safe_b64encode($data->id).'/journal'); ?>">
                                                <i class="far fa-user"></i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url('teacher/'.$this->encryption_url->safe_b64encode($data->id).'/conference-proceedings'); ?>">
                                                <i class="far fa-user"></i>
