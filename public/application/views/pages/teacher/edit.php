                                            ...
                                            <div class="row gy-4">
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="code" name="code" placeholder="Enter teacher code" value="<?php echo $data->code; ?>">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Enter teacher first name" value="<?php echo $data->first_name; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Enter teacher last name" value="<?php echo $data->last_name; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="dob" name="dob" placeholder="Enter teacher date of birth" value="<?php echo $data->dob; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="joining" name="joining" placeholder="Enter teacher date of birth" value="<?php echo $data->joining; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="email" name="email" placeholder="Enter teacher email" value="<?php echo $data->email; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Enter teacher mobile" value="<?php echo $data->mobile; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="subject" name="subject" placeholder="Enter teacher subject & specialization" value="<?php echo $data->subject; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="link" name="link" placeholder="Enter teacher website link KUH website" value="<?php echo $data->link; ?>">
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-4 col-md-6">
                                                ...
                                                <div class="col-xxl-12 col-md-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea name="address" class="form-control" id="address" placeholder="Enter teacher address" rows="5"><?php echo $data->address; ?></textarea>
                                                        <i class="invalid-message error"></i>
                                                    </div>
                                                </div>
        ...
        const prefixChoice = new Choices('#prefix', {
            choices: [
                ...
                },
                {
                    value: 'Dr',
                    label: 'Dr',
                    selected: <?php echo $data->prefix=='Dr' ? 'true' : 'false'; ?>,
                },
                {
                    value: 'Prof',
                    label: 'Prof',
                    selected: <?php echo $data->prefix=='Prof' ? 'true' : 'false'; ?>,
                },
                {
                    value: 'Sri',
                    label: 'Sri',
                    selected: <?php echo $data->prefix=='Sri' ? 'true' : 'false'; ?>,
                },
                {
                    value: 'Smt',
                    label: 'Smt',
                    selected: <?php echo $data->prefix=='Smt' ? 'true' : 'false'; ?>,
                },
                {
                    value: 'Ms',
                    label: 'Ms',
                    selected: <?php echo $data->prefix=='Ms' ? 'true' : 'false'; ?>,
                },
                {
                    value: 'Mrs',
                    label: 'Mrs',
                    selected: <?php echo $data->prefix=='Mrs' ? 'true' : 'false'; ?>,
                },
                {
                    value: 'Mr',
                    label: 'Mr',
                    selected: <?php echo $data->prefix=='Mr' ? 'true' : 'false'; ?>,
                },
                ...
                <?php foreach($designation as $designation){ ?>
                    {
                        ...
                        selected: <?php echo $data->designation_id==$designation->id ? 'true' : 'false'; ?>,
                    },
                <?php } ?>
            ],
