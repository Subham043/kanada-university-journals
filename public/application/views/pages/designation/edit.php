            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row mt-5">
                        ...
                        <!--end col-->
                        <div class="col-lg-12">
                            <form id="countryForm" method="post" action="<?php echo base_url('admin/designation/edit/'.$id); ?>" enctype="multipart/form-data">
                                <div class="card">
                                            ...
                                            <div class="row gy-4">
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="code" name="code" placeholder="Enter designation code" value="<?php echo form_error('code') ? set_value('code') : $data->code; ?>">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter designation name" value="<?php echo form_error('name') ? set_value('name') : $data->name; ?>">
