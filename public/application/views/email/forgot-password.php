                            ...
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:#ffffff;">
                                ...
                                <div class="col num4"
                                    ...
                                    <div class="col_cont" style="width:100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:15px; padding-bottom:0px; padding-right: 0px; padding-left: 48px;">
                                            <!--<![endif]-->
                                            <div align="left" class="img-container left autowidth"
                                                ...
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="left"><![endif]--><img
                                                    alt="I'm an image" border="0" class="left autowidth"
                                                    src="<?php echo base_url(); ?>assets/images/logo.png"
                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 65px; display: block;"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        style="margin: 0; font-size: 14px; line-height: 1.8; word-break: break-word; text-align: left; mso-line-height-alt: 25px; margin-top: 0; margin-bottom: 0;">
                                                        <span style="color: #2a272b;" id="dateTime"></span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <!--[if (!mso)&(!IE)]><!-->
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="color: #004afd;"><strong>
                                                        Hrudayaspandana</strong></span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 42px; color: #2a272b;"><strong>Reset Password !!</strong></span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        style="margin: 0; line-height: 1.5; word-break: break-word; text-align: center; font-size: 16px; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
                                                        <span style="font-size: 16px; color: #2a272b;">Your OTP is <b><?php echo $otp; ?></b>. Kindly click the link given below to reset your password.</span></p>
                                            ...
                                            <div align="center" class="button-container"
                                                ...
                                                <a target="_blank" href="<?php echo base_url('reset-password').'/'.$id; ?>"><div
                                                    ...
                                                    <span
                                                        style="padding-left:32px;padding-right:32px;font-size:16px;display:inline-block;letter-spacing:undefined;"><span
                                                            style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>
                                                                Reset Password</strong></span></span></div></a>
                                            ...
                                            <div align="center" class="img-container center autowidth"
                                                ...
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
                                                    ...
                                                    src="<?php echo base_url(); ?>assets/images/reminder-hero-graph.png"
...
document.getElementById("dateTime").innerHTML = `<strong>${utc}</strong>`;
</script>
