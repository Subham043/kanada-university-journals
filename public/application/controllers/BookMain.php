...
class BookMain extends CI_Controller {
    ...
    **/
    ...
    public function lists()
	{
        ...
        $config['base_url'] = base_url('book');
        $config['total_rows'] = $this->m_book->get_main_count($this->input->get('search'));
        $config['per_page'] = 10;
        ...
        $data['data'] = $this->m_book->get_main_list($config["per_page"], $page, $this->input->get('search'));

        $this->load->view('pages/book/main-list.php', $data);
    }
